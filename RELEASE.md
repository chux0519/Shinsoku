...
The workflow uses a GitHub-hosted `ubuntu-22.04` runner, installs prebuilt Qt, installs non-Qt dependencies through `vcpkg`, builds the release binary, then packages it as an AppImage with `linuxdeploy`.
